...
const Footer = () => {
  return (
    <footer className="bg-slate-900 text-slate-300 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-8 md:px-40">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-1">
            <img src={assets.logo_dark || assets.logo} alt="StudyGuide" className="h-8 mb-6 brightness-0 invert" />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><span className="hover:text-white transition-colors cursor-pointer">Become an Educator</span></li>
