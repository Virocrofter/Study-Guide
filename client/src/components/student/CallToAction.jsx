...
const CallToAction = () => {
  return (
    <div className='flex flex-col gap-4 items-center pt-10 pb-24 px-8 md:px-0'>
        ...
        <p className='text-gray-500 sm:text-sm'>Unlock your potential with our online courses. Learn from industry experts, gain new skills, and achieve your goals at your own pace.</p>
