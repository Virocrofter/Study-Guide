...
const CallToAction = () => {
  ...
  return (
    <section className="py-20 md:px-40 px-8">
      <div className="max-w-5xl mx-auto relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 via-indigo-600 to-slate-900 text-white p-12 md:p-16 text-center">
        {/* Decorative circles */}
