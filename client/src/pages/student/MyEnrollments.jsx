          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {enrolledCourses.map((course) => {
              ...
              return (
                ...
                >
                  {/* Thumbnail */}
                  <div className="relative h-48 overflow-hidden cursor-pointer" onClick={() => navigate(`/course/${course._id}`)}>
                    <img
                    ...
                    <div className="absolute top-4 right-4">
                      <div className="relative w-14 h-14">
                        <svg className="w-full h-full -rotate-90" viewBox="0 0 36 36">
                          ...
                          />
                          <path
                            className={progressPct === 100 ? "text-emerald-400" : "text-blue-500"}
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-sm text-slate-600">
                        <span className="font-bold text-slate-800">{chaptersFinished}</span> of {totalChapters} chapters finished
                      </span>
