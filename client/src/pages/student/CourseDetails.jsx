...
const CourseDetails = () => {
  ...
  const handlePreviewClick = (lectureUrl) => {
    ...
    if (videoId) {
      ...
      // Smooth scroll to top so the user sees the video player on mobile
  ...
  if (!courseData)
    return <div className="text-center pt-40">Course not found.</div>;
  ...
  return (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left bg-linear-to-b from-cyan-100/70">
                        ...
                        <li key={i} className="flex items-start gap-2 py-1">
                          ...
                          <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-sm">
                            ...
                            {lecture.isPreviewFree && (
                              <p
                                onClick={() =>
                                  handlePreviewClick(lecture.lectureUrl)
                                }
        ...
        {/* Video Player Card */}
        <div className="max-w-course-card z-10 shadow-lg rounded overflow-hidden bg-white min-w-[300px] sticky top-24">
          {playerData ? (
            <Youtube
